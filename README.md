...
2. Так как в сваггере не было указано поле с ID в таблице People, считаем поля "name" и "surname" уникальными индификаторами. Так же считаем, что полных тёзок в БД нет.
